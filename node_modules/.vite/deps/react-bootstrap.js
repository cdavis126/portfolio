import {
  ...
  useNavItem
} from "./chunk-3AC6YMX3.js";
import {
  Button_default as Button_default2
} from "./chunk-WB62I6VI.js";
import {
  Button_default,
  useButtonProps
...
} from "./chunk-2O4DAIE2.js";
import {
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-5NNHOFRB.js";
import {
  CardBody_default,
  CardFooter_default,
...
var CardGroup = React12.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React13.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function forEach(children, func) {
  ...
  React15.Children.forEach(children, (child) => {
    if (React15.isValidElement(child)) func(child, index++);
  });
}
...
function useDropdownMenu(options = {}) {
  const context3 = (0, import_react23.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context3 = (0, import_react28.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var context = React29.createContext(null);
...
var Switch = React51.forwardRef((props, ref) => (0, import_jsx_runtime51.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal2 = React66.forwardRef(({
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
...
var NavItem = React67.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav = React69.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
...
var Offcanvas = React77.forwardRef(({
  ...
  const renderBackdrop = (0, import_react58.useCallback)((backdropProps) => (0, import_jsx_runtime78.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime95.jsxs)(import_jsx_runtime94.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react65.cloneElement)(children, triggerProps), (0, import_jsx_runtime93.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ToastFade = React107.forwardRef((props, ref) => (0, import_jsx_runtime116.jsx)(Fade_default, {
  ...props,
  ref,
